...
int main(void)
{
    ...
    u8g2_InitDisplay(&u8g2_a);
    u8g2_SetPowerSave(&u8g2_a, 0);
    ...
    u8g2_InitDisplay(&u8g2_b);
    u8g2_SetPowerSave(&u8g2_b, 0);
    ...
    while (1)
    {
        ...
        u8g2_FirstPage(&u8g2_a);
        do
        {
            draw(&u8g2_a);
        }
        while (u8g2_NextPage(&u8g2_a));

        u8g2_FirstPage(&u8g2_b);
        do
        {
            draw(&u8g2_b);
        }
        while (u8g2_NextPage(&u8g2_b));
